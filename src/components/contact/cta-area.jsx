...
const cta_content = {
  ...
  title: "Try our software now!",
  description: (
    <>
      Boost your creative workflow with Framespik, the ultimate SaaS solution
      for seamless design collaboration and rapid prototyping.
    </>
  ),
