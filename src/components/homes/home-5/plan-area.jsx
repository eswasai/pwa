...
const plan_content = {
  ...
  sub_title: "Flexible Plans",
  title: (
    <>
      Tailored to <span>Every Business</span> size{" "}
    </>
  ),
};
...
const accordion_data = [
  {
    id: 1,
    question: "Flexible Pricing",
    answer: <>Affordable plans tailored to suit businesses of any scale.</>,
  ...
  {
    id: 2,
    question: "Customizable Plans",
    answer: (
      <>Flexible options to adjust features and services based on your needs.</>
    ),
