...
const cta_content = {
  ...
  sub_title: "Stunning Tools",
  title: (
    <>
      <span>Simplify Business</span>
      <br /> in one single platform
    </>
  ),
  des: (
    <>
      Unlock the potential of your business with our powerful suite of tools
       designed to streamline processes and enhance efficiency.
    </>
  ),
  feature_list: [
    "All-in-One Solution",
