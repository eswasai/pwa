...
const TestimonialArea = () => {
  ...
  return (
    <>
      <div className="tp-testimonial__area pt-105 pb-20 fix">
            ...
            <div className="col-xl-10">
              <div className="tp-testimonial__slider-section">
                <Slider
                  ...
                  data-wow-delay=".5s"
                >
                  {testimonial_data.slice(0, 9).map((item, i) => (
                        ...
                        <div className="row gx-0 ">
                          <div className="col-xl-7 col-lg-7 ">
                            <div className="tp-testimonial__left-item p-relative">
                              <div className="tp-testimonial__content z-index mt-30 mb-30">
                                <p>{item.description} </p>
                              </div>
                              <div className="tp-testimonial__author-info z-index mb-30">
                                <span>{item.name}</span>
                                <i>{item.title}</i>
                              </div>
                            </div>
