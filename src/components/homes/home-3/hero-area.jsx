...
const hero_content = {
  title_1: (
    <>
      Scales <span>Customers</span>
    </>
  ),
  title_2: "Capture Success.",
  info: (
    <>Framespik is a SaaS platform streamlining data management, branding.</>
  ),
  btn_1: "Get Started",
  btn_2: "Contact Sales",
};
...
const HeroArea = () => {
  ...
  return (
    <>
      <div className="tp-hero-area tp-hero-pt pt-170 pb-25 p-relative">
        ...
        <div className="container">
          <div className="row justify-content-center z-index-3">
            <div className="col-xl-11">
              ...
              <div className="tp-hero-3-wrapper p-relative mt-lg-0  mt-40">
