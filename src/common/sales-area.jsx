...
const sales_content = {
  title: (
    <>
      Effortlessly <span>Schedule Events</span> and <span>Manage Tasks</span>
    </>
  ),
  dub_title: <>Streamline Team Schedules and Task Assignments with Ease</>,
  description: (
    <>
      Plan, assign, and manage your team's schedules and tasks, <br />
      ensuring smooth coordination and timely event execution.
    </>
  ),
  ...
  sales_feature: [
    {
      id: 1,
      color: "yellow-1",
      list: "Create and assign schedules for multiple events quickly.",
    },
    {
      id: 2,
      color: "purple-2",
      list: "Send real-time task updates and reminders to your team.",
    },
    {
      id: 3,
      color: "green-3",
      list: "Easily integrate schedules with your existing tools and workflow.",
    },
  ],
