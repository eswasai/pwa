            ...
            <div className="row align-items-start">
              <div className="col-6">
                <div className="header-top__link">
                  <span>
                    Offer <i>is going on till Friday, $8.99/mo. </i>
                  </span>
                  <Link href="#">
                    <svg
                      width="7"
              ...
              <div className="col-6">
                <div className="header-top__support text-end">
                  <span>
                    Get Support:{" "}
                    <Link href="tel:+919390726366">9390726366</Link>
                  </span>
                </div>
              </div>
            </div>
        ...
        >
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-xxl-6 col-xl-6 col-lg-6 d-none d-lg-block d-lg-flex align-items-center justify-content-center">
