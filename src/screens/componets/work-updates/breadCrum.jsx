...
const projectDetailsData = [
  {
    id: 1,
    cls: "overview",
    title: "Work Updates on Framespik CRM",
    featureList: [
      "Effortless Event Management",
      "Staff and Task Updates",
    ...
    description: (
      <>
        <ul>
          <li>
            <strong>Real-Time Work Updates:</strong> Event managers and
            photographers can easily log updates about ongoing work, ensuring
            clients are always informed about the status of their event.
          </li>
          <li>
            <strong>Transparent Progress Tracking:</strong> Clients can access
            detailed updates regarding staff assignments, task completion, and
            event readiness.
          </li>
          <li>
            <strong>Streamlined Workflow:</strong> Use the CRM to efficiently
            coordinate between team members and clients, enhancing overall event
            execution.
          </li>
        </ul>
      </>
    ...
    bottomDescription: (
      <>
        <ul>
          <li>
            <strong>Task Assignments Made Easy:</strong> Update the CRM with
            staff roles and responsibilities, ensuring a clear view of who is
            handling what.
          </li>
          <li>
            <strong>Client Notifications:</strong> Instantly notify clients
            about major milestones, such as the completion of photography, setup
            progress, or delivery timelines.
          </li>
        </ul>
      </>
    ),
            ...
            <div className="col-xl-2 col-lg-2 social-box-pin">
              <div className="pd-details-social-box text-lg-center text-start p-relative">
                ...
                <div className="pd-details-social">
                  <SocialLinks
                    shareTitle={`Work Updates`}
                    shareText={` Streamline collaboration between team members and clients for seamless event execution.`}
                    shareUrl={"https://framespik.com/work-updates"}
                  />
                </div>
              </div>
            </div>
