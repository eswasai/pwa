...
const feature_data = [
  ...
  },
  {
    ...
    title: (
      <>
        Assign and Track <br /> Staff Tasks
      </>
    ),
    delay: ".6s",
  },
...
const feature_content = {
  title: "Work Updates Highlights",
  sub_title:
    "Track tasks, monitor progress, and keep clients updated—all from one platform.",
};
...
const workFeatures = () => {
  ...
  return (
    <>
      <div className="tp-feature__area tp-feature__pt-pb pb-170 p-relative">
