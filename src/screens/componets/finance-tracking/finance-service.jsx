...
const service_content = {
  title: (
    <>
      Finance Tracking <br /> For Seamless Business Management.
    </>
  ),
  btn_text: <>Explore All Features</>,

  bg_img: "/assets/img/service/service-3-bg.png",
  service_title: "Payment and Expense Management",
  service_info: (
    <>
      Track Payments, Monitor Expenses, <br /> and Optimize Cash Flow
      Automatically.
    </>
  ),
};
...
const FinanceServices = () => {
  return (
    <>
      <div className="tp-service-area pb-80 pt-80 z-index ">
        <div className="container">
          ...
          <div className="row">
              ...
              >
                ...
                <div className="tp-service-3-content">
                  ...
                  <h4 className="tp-service-3-title-sm">
                    <Link href="/get-started">{service_info}</Link>
                  </h4>
                </div>
                <div className="tp-service-3-btn">
                  <Link className="tp-btn-white-solid" href="/get-started">
                    Learn More
                  </Link>
                </div>
            ...
            {service_data.slice(17, 18).map((item, i) => (
              <div
                key={i}
                ...
                <div className="tp-service-sm-item mb-30 d-flex flex-column justify-content-between">
                  ...
                  <div className="tp-service-sm-content">
                    ...
                    <h3 className="tp-service-sm-title">
                      <Link href="/get-started">{item.description}</Link>
                    </h3>
