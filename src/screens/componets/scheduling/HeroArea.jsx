...
const company_content = {
  ...
  info_1: (
    <>
      Efficiently organize events and manage your team with a powerful
      scheduling tool designed to simplify your workflow. Assign tasks, set
      deadlines, and keep everyone on the same page effortlessly.
    </>
  ),
  info_2: (
    <>
      Notifications ensure that schedules and updates are instantly shared with
      team members, helping everyone stay informed and productive. No more
      missed deadlines or confusion.
    </>
  ),
  info_3: (
    <>
      Our intuitive scheduling interface and seamless CRM integration offer
      peace of mind, letting you focus on delivering exceptional results for
      every event.
    </>
  ),
};
