...
const integration_content = {
  title: (
    <>
      <span>Trusted</span> <br /> Businesses Worldwide
    </>
  ),
  des: (
    <>
      Framespik CRM is relied upon by countless businesses globally, <br />
      empowering them to build stronger customer relationships.
    </>
  ),
...
const CrmTestimonials = () => {
  return (
    <>
      <div className="tp-intigration-area tp-intigration-five-space fix pt-5">
