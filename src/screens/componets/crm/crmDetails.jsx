...
const service_content = {
  ...
  sub_title: "What Framespik Offers",
  title: (
    <>
      Real-Time Insights <br />
      Into Your <br />
      <span>CRM</span> <br /> <span>Business</span>
    </>
  ),
  description: (
    <>
      Gain the insights you need to nurture relationships, <br />
      drive sales, and make informed decisions.
    </>
  ),
