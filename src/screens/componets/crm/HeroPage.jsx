              ...
              <div className="tp-hero-five-section-wrap">
                <div className="tp-hero-five-section-box z-index">
                  <h3 className="tp-hero-title-5 hero-text-anim-2">
                    ...
                    <i>
                      <i className="child-2">
                        <span className="child-2">CRM</span> Solutions <br />
                      </i>
                    </i>
                    <i>
                      <i className="child-2">for Your Success</i>
                    </i>
                  </h3>
                  <p
                    ...
                    data-wow-delay=".5s"
                  >
                    Framespik CRM empowers your business with advanced tools for
                    managing <br />
                    customer relationships, optimizing workflows, and enhancing
                    collaboration.
                  </p>
                </div>
                ...
                >
                  ...
                  <Link className="tp-btn-grey mb-20" href="./contact">
                    Contact{" "}
                  </Link>
                </div>
              </div>
