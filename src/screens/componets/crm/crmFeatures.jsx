...
const service_content = {
  ...
  title: (
    <>
      Need assistance? <span>Don’t hesitate to contact us</span> 
    </>
  ),
  description: (
    <>
     We’re here to support you whenever needed!
    </>
  ),
  btn_text: "Contact Us",
};
...
const crmFeatures = () => {
  return (
    <>
      <div className="tp-service-area tp-services-five-item-bg-color p-relative fix mb-120">
