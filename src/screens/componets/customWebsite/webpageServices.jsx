...
const service_content = {
  title: (
    <>
      Website Builder <br /> That Does it All.
    </>
  ),
  btn_text: <>Discover All Features</>,

  bg_img: "/assets/img/service/service-3-bg.png",
  service_title: "Website Management",
  service_info: (
    <>
      Create, Customize, and Launch websites <br /> effortlessly with advanced
      tools.
    </>
  ),
};
                ...
                <div className="tp-service-sm-item mb-30 d-flex flex-column justify-content-between">
                  ...
                  <div className="tp-service-sm-content">
                    ...
                    <h3 className="tp-service-sm-title">
                      <Link href="/download">{item.description}</Link>
                    </h3>
