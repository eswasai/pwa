...
const payment_content = {
  title: (
    <>
      Build Stunning <br /> Websites with Ease.
    </>
  ),
  sub_title: <>All the tools you need to create your dream website</>,
  box_1: [
    {
      id: 1,
      col: "md-6",
      ...
      des: (
        <>
          Use our intuitive drag-and-drop editor to design your website exactly
          how you want, without any coding skills.
        </>
      ),
      shapes: [
        {
    ...
    },
    {
      ...
      des: <>Connect your custom domain easily or use one provided by us.</>,
      shapes: [
        {
          id: 1,
          cls: "9",
  ...
  box_3_title: <>Fully Responsive & SEO-Friendly Designs.</>,
  box_3_des: (
    <>
      Ensure your website looks great on all devices and gets discovered easily
      with built-in SEO tools.
    </>
  ),
  box_3_btn: "Explore Website Tools",
};
