...
// about content
const about_content = {
  title: "OVER 1M+ OBJECTS UPLOADING EVERYDAY",
  sub_title: "We Offer Speed And Sclable Cloud Solutions",
  des: (
    <>
      Our global collaborations with leading industry giants have enabled us to
      deliver high-quality services at the most competitive costs.
    </>
  ),

  about_list: [
    <>Excellence Through Global Partnerships.</>,
    <>Affordable Solutions Without Compromise.</>,
    <> Unlimited Storage with Seamless Scalability.</>,
  ],
