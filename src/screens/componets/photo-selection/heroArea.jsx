...
const about_content = {
  ...
  sub_title: "Select Unlimited Photos",
  des: (
    <>
      Framespik allows you to easily select your favorite photos for a seamless
      photo selection experience.
    </>
  ),

  about_list: [
    <>Analyze the photo count.</>,
    <>Access on multiple devices (any device).</>,
    <>Choose your photo preferences.</>,
  ],
...
const HeroArea = () => {
  return (
    <>
      <div className="tp-about__area tp-about__pt-pb pb-80">
