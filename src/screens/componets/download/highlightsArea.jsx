...
const feature_content = {
  ...
  sub_title: "More than 100's TB of data stored at the most affordable prices.",
};
...
const FeatureArea = () => {
  ...
  return (
    <>
      <div className="tp-feature__area tp-feature__pt-pb pt-165 pb-200 p-relative">
