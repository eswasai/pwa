...
const plan_content = {
  ...
  feature_items: [
    ...
    { id: 4, cls: "", title: "Gold", btn_text: "Get Deluxe" },
  ],
  feature_lists: [
    {
      id: 1,
                ...
                <div className="row gx-0 align-items-center">
                  <div className="col-xl-3 col-lg-3 col-md-3">
                    <div className="pr-feature-head">
                      <div className="pr-feature-title-box d-none d-md-block">
...
export default PlanDetialsComponents;
