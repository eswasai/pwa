...
const UpdateInfoMainContainer = () => {
  ...
  // app update
  const [appupdateCount, setAppupdateCount] = useState("");
  const [appCharges, setAppCharges] = useState(null);
  const [appupdateTotal, setAppupdateTotal] = useState(0);
...
export default UpdateInfoMainContainer;
