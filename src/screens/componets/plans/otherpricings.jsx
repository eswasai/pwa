...
import "@/assets/css/otherpricing/otherpricing.css";
...
const OtherPricing = ({ num = 0, Heromb = 120 }) => {
  ...
  const storageSizeNumber = Number(storageSize);

  return (
    <>
      <div className={`container mb-${Heromb} mt-${num}`}>
        <div className="mt-90 mb-70 ">
          <h1 className="fw-bold" style={{ color: "#000", fontSize: "4rem" }}>
            Other Pricings
          </h1>
          <p className="mt-20 fw-bold">
