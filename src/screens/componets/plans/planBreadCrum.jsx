...
const PlansBreadCrum = () => {
  const { animeRef } = useBreadcrumbTitleAnime();
  return (
    <>
      <div className="breadcrumb__area breadcrumb-ptb-5 p-relative blue-bg-2 pb-4">
          ...
          <div className="row align-items-end">
            ...
            <div className="col-xl-3 col-lg-5 col-md-5">
              <div className="tp-price__btn-box tp-price__btn-inner">
                ...
                <nav>
                  <div
                    className="nav nav-tab tp-price__btn-bg z-index-3"
                    id="nav-tab"
                    role="tabList"
                  >
                    <button
