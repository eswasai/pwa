...
const ViewRow = () => {
  return (
    <>
      <div className="tp-security-area  pb-180 fix z-index">
        <div className="container-fluid g-0">
          <div className="row justify-content-center">
            <div className="col-xl-8">
              <div className="tp-security-section-box text-center pb-50">
                <h5
                  style={{ color: "#4441cf" }}
                ...
                <h3 className="tp-section-title-4 text-dark">
