...
const service_content = {
  title: <>Access your photos anywhere, anytime</>,
  des: <>We bring your memories to life, wherever you are</>,
  ...
  users_data: [
    ...
    },
    {
      ...
      users_status: <>PIN-Protected Access</>,
    },
  ],
...
const { title, des, users_data, service_data } = service_content;

const ViewService = () => {
  return (
    <>
      <div className="tp-service-2__area p-relative pt-70 pb-160 mt-120">
          ...
          <div className="row align-items-center mb-50">
            ...
            >
              <div className="tp-service-2__user-box p-relative d-flex justify-content-lg-start justify-content-lg-end align-items-center">
                <div className="tp-service-2__user-shape mt-10">
                  <LinearGradientLine />
                </div>
                ...
                <div className="tp-service-2__item-wrapper p-relative">
                  <div className="tp-service-2__item d-flex justify-content-between flex-column">
                    ...
                    <div className="tp-service-2__text">
                      ...
                      <Link className="tp-service-2__link" href="/get-started">
                        Explore
