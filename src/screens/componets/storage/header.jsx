...
import NavMenu from "../../../layout/headers/nav-menu";
import Image from "next/image";

import logo from "@/assets/img/logo/logo-with-text.svg";
import white_logo from "@/assets/img/logo/logo-with-text.svg";
import black_logo from "@/assets/img/logo/logo-with-text.svg";

const StorageHeader = ({ style_error }) => {
