...
const service_content = {
  title: "Discover the Power of Vision Camera",
  sub_title: (
    <>Empowering over 15,000 photographers with innovative solutions</>
  ),

  bg_img: "/assets/img/service/sv-bg.jpg",
  title_2: (
    <>
      Visualize Poses <br /> with Precision
    </>
  ),
  des: (
    <>
      Transform photo sessions by providing real-time pose guidance <br /> and
      building client confidence effortlessly.
    </>
  ),
  btn_text: "Learn More",
};
