...
const projectDetailsData = [
  {
    ...
    featureList: ["Cloud Integration", "DNS Hosting", "Seamless Connectivity"],
    description: (
      <>
        <ul>
          <li>
            <strong>Cloud Integration:</strong> Easily integrate with other
            cloud services to streamline data management and enhance your
            storage options.
          </li>
          <li>
            <strong>Seamless DNS Hosting:</strong> Connect your domain with
            popular DNS hosting providers for optimized performance and
            management.
          </li>
          <li>
            <strong>Enhanced Connectivity:</strong> Enjoy smooth integration
            between multiple platforms for a unified experience across your
            systems.
          </li>
        </ul>
      </>
    ...
    bottomDescription: (
      <>
        <ul>
          <li>
            <strong>Flexible Cloud Solutions:</strong> Expand your storage
            capacity and simplify cloud data management through third-party
            integrations.
          </li>
          <li>
            <strong>Reliable DNS Hosting:</strong> Ensure reliable, fast, and
            secure DNS hosting connections for your services with leading
            providers.
          </li>
        </ul>
        <div>
          <p>
            Empower your systems with advanced <span style={{textDecoration:'underline',textDecorationColor:'#600ee4'}}>third-party integrations</span>  that
            deliver unparalleled flexibility and efficiency. By embracing a
            ...
            <div className="col-xl-2 col-lg-2 social-box-pin">
              <div className="pd-details-social-box text-lg-center text-start p-relative">
                ...
                <div className="pd-details-social">
                  <SocialLinks
                    shareTitle={`3rd Party Integration`}
                    shareText={`Connect effortlessly with leading cloud platforms to unify your data and enhance operational efficiency.`}
                    shareUrl={"https://framespik.com/3rd-party-integration"}
                  />
                </div>
              </div>
            </div>
