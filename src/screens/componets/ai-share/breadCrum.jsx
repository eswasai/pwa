...
const projectDetailsData = [
  {
    ...
    featureList: ["Event Convenience", "QR Scanning", "Face Registration"],
    description: (
      <>
        <ul>
          <li>
            <strong>Seamless Guest Access:</strong> Event guests can
            effortlessly view their images through AI-powered sharing, ensuring
            no one misses their memories.
          </li>
          <li>
            <strong>AI-Driven Image Distribution:</strong> Photographers can
            place QR code boards at events, allowing guests to register their
            faces and details via a simple scan.
          </li>
          <li>
            <strong>Automated Delivery:</strong> Guests receive their
            personalized images via WhatsApp within 2-3 days, ready to download
            and share.
          </li>
        </ul>
      </>
    ...
    bottomDescription: (
      <>
        <ul>
          <li>
            <strong>Quick Registration:</strong> Guests scan the QR code,
            register their faces, and provide their details through WhatsApp in
            seconds.
          </li>
          <li>
            <strong>Personalized Image Access:</strong> Using AI, the system
            matches registered faces to photos and ensures accurate delivery to
            each guest.
          </li>
        </ul>
        <div>
          ...
          <p>
            This system is designed to make capturing and sharing your event
            memories effortless and enjoyable. It eliminates the hassle of
            sifting through hundreds of photos to find your own. Instead, with
            just a quick face registration and a little patience, your
            personalized photos are delivered directly to your WhatsApp within a
            few days. <br /> It's a modern, seamless way to relive your favorite
            moments from the event without any extra effort!
          </p>
        </div>
      </>
    ),
            ...
            <div className="col-xl-2 col-lg-2 social-box-pin">
              <div className="pd-details-social-box text-lg-center text-start p-relative">
                ...
                <div className="pd-details-social">
                  <SocialLinks
                    shareTitle={`AI Image Share`}
                    shareText={`Make Your Memories Easy to Access!`}
                    shareUrl={"https://framespik.com/ai-image-delivery"}
                  />
                </div>
              </div>
            </div>
