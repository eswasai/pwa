  ...
  hero_title: (
    <>
      <span className="tp_title">
        <span className="child">AI-Powered Face Scan</span>
      </span>{" "}
      <br />
      <span>
        <span className="child">Revolutionizing Event Photography</span>
      </span>{" "}
    </>
  ),
  hero_shape_img: [
  ...
  return (
    <>
      <div className="tp-hero__area tp-hero__pl-pr">
        <div className="tp-hero__bg p-relative" style={{ paddingTop: "0%" }}>
            ...
            <div className="row justify-content-center">
              <div className="col-xl-10">
                <div className="tp-hero__content-box text-center z-index-3">
                  ...
                  <div
                    className="tp-hero__input p-relative wow tpfadeUp d-flex flex-row align-items-center justify-content-center"
