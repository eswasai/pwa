...
const account_content = {
  ...
  sub_title: "Face Scan Registration",
  title: "Let’s get started with AI Face Scan",
  account_step: [
    {
      id: 1,
      number: "01",
      info: <>Scan the QR code at the event</>,
    },
    {
      id: 2,
      number: "02",
      info: <>Register your face and fill in your details</>,
    },
    {
      id: 3,
      number: "03",
      info: (
        <>
          Your face is registered; receive your <br /> personalized images via
          WhatsApp in a few days
        </>
      ),
    },
  ],
  btn_text: "Register Your Face in Seconds",
};
...
const FaceScanSteps = () => {
  return (
    <>
      <div className="tp-account-area pb-120 pt-180">
