...
const plan_content = {
  ...
  sub_title: "Flexible Streaming",
  title: (
    <>
      Designed for <span>All Business Sizes</span>
    </>
  ),
};
...
const accordion_data = [
  {
    id: 1,
    question: "Unlimited Downloads & Viewing",
    answer: (
      <>
        Download and view your 4K videos as many times as you need, without any
        restrictions.
      </>
    ),
  ...
  {
    id: 2,
    question: "Seamless Video Sharing",
    answer: (
      <>
        Easily share your 4K videos with clients or friends through a simple
        link or media sharing platforms.
      </>
    ),
