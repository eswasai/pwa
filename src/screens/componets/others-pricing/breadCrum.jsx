...
import OtherPricingMainContainer from "./other-pricing-maincontainer";
import OtherPricing from "../plans/otherpricings";

const OtherPricingBreadCrum = () => {
            ...
            <div className="col-xl-9 col-lg-7 col-md-7">
              <div className="price-banner z-index-3">
                <div className="price-banner-title-box">
                  <h3
                    ref={animeRef}
                    className="price-banner-title tp-char-animation anime_text mb-0"
                  >
                    Other Pricings
                  </h3>
                </div>
...
export default OtherPricingBreadCrum;
