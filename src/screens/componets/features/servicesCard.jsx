...
const card_content = {
  ...
  title: (
    <>
      Control <span>Everything</span> in One Place{" "}
    </>
  ),
  description: (
    <>
      Manage, store, and share your media seamlessly in one place. Effortless
...
const CardArea = ({ style_service, spacing = "pb-185" }) => {
  return (
    <>
