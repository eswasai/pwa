...
const service_content = {
  ...
  title: (
    <>
      Get Live <br />
      Designs <br />
      <span>Select</span> <span>Multiple Screens</span>
    </>
  ),
  description: (
    <>View sample output screens and scan the QR on your mobile device.</>
  ),
    ...
    <>
      <div className="tp-service-area tp-services-five-item-bg-color p-relative fix ">
        <div className="container-fluid p-0">
          ...
          ></div>
          <div className="row g-0 align-items-center mb-120">
