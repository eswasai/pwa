...
const rated_content = {
  author: [
    {
      id: 1,
      title: <>"the encryption is excellent"</>,
      img: author_img_1,
    },
    {
      id: 2,
      title: <>"improvements in Business"</>,
      img: author_img_2,
    },
    {
      id: 3,
      title: <>"Data Safety at minimal charge"</>,
      img: author_img_3,
    },
  ],
  ...
  title: (
    <>
      Customers have <span>Choose Data Safety</span>
      <br /> <span>Rated</span> Framespik<span> 4.9/5</span>
    </>
  ),
};
...
const DataSafeRatings = () => {
  return (
    <>
      <div className="tp-rated-area fix p-relative pt-120">
        <div
              ...
              <div className="col-xl-10">
                <div className="tp-rated-title-box text-center mb-60">
                  ...
                  <Link
                    ...
                    href="/blogs"
                  >
                    <span className="text-color-black">Know more details</span>
                    <b></b>
                  </Link>
                </div>
              </div>
...
export default DataSafeRatings;
