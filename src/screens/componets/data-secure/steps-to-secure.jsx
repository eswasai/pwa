...
const platform_data = [
  {
    ...
    cls: "one",
    count: "01",
    title: "Open Data-Safe",
    sub_title: "Open Data-Safe",
    des: <>Open the Data-Safe feature and click on "Upload."</>,
  },
  {
    id: 2,
    cls: "two",
    ...
    des: <>Upload your file, whether it is an original or raw image.</>,
  },
  {
    id: 3,
    cls: "three",
    ...
    sub_title: "Download ready",
    des: (
      <>
        Reopen the Data-Safe, select your file, and complete a minimal payment.
      </>
    ),
  },
  {
    ...
    sub_title: "Final Download",
    des: <>Download your raw files securely and worry-free.</>,
  },
];

const SteptoSecure = ({ style_carrer }) => {
    ...
    <>
      <div
        className={`fix tp-platform-area ${
          style_carrer
            ? "tp-platform-inner pb-20 pt-100"
